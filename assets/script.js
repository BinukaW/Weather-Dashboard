...
var apiKey = "2660e15a2d8319e08a4ac9ad87645c9f";
...
searchButton.click(function () {
    ...
    if (searchInput == "") {
        ...
        $.ajax({
            ...
            var urlUV = `https://api.openweathermap.org/data/2.5/uvi?appid=2660e15a2d8319e08a4ac9ad87645c9f=${response.coord.lat}&lon=${response.coord.lon}`;
